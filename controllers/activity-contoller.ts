...
import { User } from "../types/activity.ts";
...
const getActivities = ({ response }: { response: any }) => {
  ...
  const testCode = ({ response }: { response: any }) => {
    response.body = {
      success: true,
      msg: 'Hello World I am Test Code',
    };
  };
  ...
  export { getActivities, getActivity, addActivity, updateActivity, deleteActivity, testCode, addUser, getUsers, getUser }
